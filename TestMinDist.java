...
public class AnirudhGokulaprasad_TestMinDist extends ApplicationSetupBasedTest {
	@Test public void testOneDocTwoTerms() throws Exception {
		...
		AnirudhGokulaprasad_MinDist sample = new AnirudhGokulaprasad_MinDist();
